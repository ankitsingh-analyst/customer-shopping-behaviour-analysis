...
select subscription_status, count(customer_id) as total_customers, avg(purchase_amount),sum(purchase_amount) as total_revenue
from customer_shopping_behaviour
...
select subscription_status,count(customer_id) as subscribed_members
from customer_shopping_behaviour
